...
from .models import Product, Category, ReviewRating, ImageGallery
...
#         return redirect('product_detail', cat_slug=product.category.slug, pro_slug=product.slug)

#     return redirect('product-detail', cat_slug=product.category.slug, pro_slug=product.slug)